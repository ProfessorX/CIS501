...
\title{Big Data with Ensemble Selection}
...
and then make some modification to it. Later we run our process in
Amazon cloud servers. We obtain a quite satisfactory result, the
average score is 75\%.
...
\IEEEPARstart{W}{e} proposed an approach to tackle the KDD Cup 2009
in~\cite{Ref:Yanan2013}. We planned to carry out a meta classification
method, i.e.\ ensemble selection with a reduced set of base
classifiers when compared
with~\cite{Ref:WinningtheKDDCupIBMResearch}. 
